...
impl RpcServer for RpcServerImpl {
    ...
    async fn merkle_proof(&self, keys: Vec<SmtKey>) -> Result<SmtProof, Error> {
        ...
        let rocksdb_store_smt = DefaultStoreSMT::new(root, DefaultStore::<_, ()>::new(&snapshot));
